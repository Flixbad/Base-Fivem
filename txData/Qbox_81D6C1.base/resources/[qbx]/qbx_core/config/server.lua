return {
    ...
    money = {
        ...
        ---@type Money
        moneyTypes = { cash = 500, bank = 0, crypto = 0 }, -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
